...
/// shows a popup menu, consider using [PopupMenuButton1].
///
...
/// [PopupMenuItem1]), or no value at all (for example, [PopupMenuDivider]).
///
/// See also:
///
///  * [PopupMenuItem1], a popup menu entry for a single value.
///  * [PopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [CheckedPopupMenuItem], a popup menu item with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton1], an [IconButton] that automatically shows a menu when
///    it is tapped.
...
/// See also:
///
///  * [PopupMenuItem1], for the kinds of items that this widget divides.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton1], an [IconButton] that automatically shows a menu when
///    it is tapped.
...
///
/// Typically the [child] of a [PopupMenuItem1] is a [Text] widget. More
/// elaborate menus with icons can use a [ListTile]. By default, a
/// [PopupMenuItem1] is [kMinInteractiveDimension] pixels high. If you use a widget
...
/// {@end-tool}
///
/// See the example at [PopupMenuButton1] for how this example could be used in a
/// complete menu, and see the example at [CheckedPopupMenuItem] for one way to
/// keep the text of [PopupMenuItem1]s that use [Text] widgets in their [child]
/// slot aligned with the text of [CheckedPopupMenuItem]s or of [PopupMenuItem1]
/// that use a [ListTile] in their [child] slot.
///
/// See also:
///
///  * [PopupMenuDivider], which can be used to divide items from each other.
///  * [CheckedPopupMenuItem], a variant of [PopupMenuItem1] with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton1], an [IconButton] that automatically shows a menu when
///    it is tapped.
...
/// The [State] for [PopupMenuItem1] subclasses.
///
/// By default this implements the basic styling and layout of Material Design
/// popup menu items.
///
/// The [buildChild] method can be overridden to adjust exactly what gets placed
/// in the menu. By default it returns [PopupMenuItem1.child].
///
/// The [handleTap] method can be overridden to adjust exactly what happens when
/// the item is tapped. By default, it uses [Navigator.pop] to return the
/// [PopupMenuItem1.value] from the menu route.
///
/// This class takes two type arguments. The second, `W`, is the exact type of
/// the [Widget] that is using this [State]. It must be a subclass of
/// [PopupMenuItem1]. The first, `T`, must match the type argument of that widget
...
class PopupMenuItemState<T, W extends PopupMenuItem1<T>> extends State<W> {
  ...
  ///
  /// By default, this returns [PopupMenuItem1.child]. Override this to put
  ...
  ///
  /// By default, uses [Navigator.pop] to return the [PopupMenuItem1.value] from
  /// the menu route.
  @protected
  void handleTap() {
    widget.onTap?.call();
...
/// matches the default minimum height of a [PopupMenuItem1]. The horizontal
...
/// See also:
///
///  * [PopupMenuItem1], a popup menu entry for picking a command (as opposed to
///    toggling a value).
///  * [PopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton1], an [IconButton] that automatically shows a menu when
///    it is tapped.
class CheckedPopupMenuItem<T> extends PopupMenuItem1<T> {
...
///  * [PopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [CheckedPopupMenuItem], a popup menu item with a checkmark.
///  * [PopupMenuButton1], which provides an [IconButton] that shows a menu by
...
/// argument is the value of the [PopupMenuItem1] that caused its menu to be
/// dismissed.
///
/// Used by [PopupMenuButton1.onSelected].
typedef PopupMenuItemSelected<T> = void Function(T value);

/// Signature for the callback invoked when a [PopupMenuButton1] is dismissed
/// without selecting an item.
///
/// Used by [PopupMenuButton1.onCanceled].
typedef PopupMenuCanceled = void Function();

/// Signature used by [PopupMenuButton1] to lazily construct the items shown when
/// the button is pressed.
///
/// Used by [PopupMenuButton1.itemBuilder].
...
/// then [PopupMenuButton1] behaves like an [IconButton].
///
...
///  * [CheckedPopupMenuItem], a popup menu item with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
class PopupMenuButton1<T> extends StatefulWidget {
  /// Creates a button that shows a popup menu.
  ///
  /// The [itemBuilder] argument must not be null.
  const PopupMenuButton1({
    super.key,
  ...
  @override
  PopupMenuButton1State<T> createState() => PopupMenuButton1State<T>();
}

/// The [State] for a [PopupMenuButton1].
///
/// See [showButtonMenu] for a way to programmatically open the popup menu
/// of your button state.
class PopupMenuButton1State<T> extends State<PopupMenuButton1<T>> {
  /// A method to show a popup menu with the items supplied to
  /// [PopupMenuButton1.itemBuilder] at the position of your [PopupMenuButton1].
  ///
  /// By default, it is called when the user taps the button and [PopupMenuButton1.enabled]
  /// is set to `true`. Moreover, you can open the button by calling the method manually.
  ///
  /// You would access your [PopupMenuButton1State] using a [GlobalKey] and
